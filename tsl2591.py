...
class TSL2591:
    ...
    def _read_u8(self, address):
        ...
        self._device.writeto(_TSL2591_ADDR, bytes([self._BUFFER[0]]))
        self._BUFFER[0] = struct.unpack('b',self._device.readfrom(_TSL2591_ADDR,1))[0]
    ...
    def _read_u16LE(self, address):
        ...
        self._BUFFER[0] = (_TSL2591_COMMAND_BIT | address) & 0xFF
        self._device.writeto(_TSL2591_ADDR,bytes([self._BUFFER[0]]))
        #tmp_tpl = struct.unpack('b',self._device.readfrom(_TSL2591_ADDR,2))
        tmp_tpl=self._device.readfrom(_TSL2591_ADDR,2)
        #print(tmp_tpl)
        self._BUFFER[0] = tmp_tpl[0]
        self._BUFFER[1] = tmp_tpl[1]
    ...
    def _write_u8(self, address, val):
        ...
        self._device.writeto(_TSL2591_ADDR,bytes(self._BUFFER))
